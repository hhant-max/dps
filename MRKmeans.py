...
class MRKmeans(MRJob):
    def __init__(self, *args, **kwargs):
        ...
        self.ndim = 3
        self.nclass = 2
        self.centroids = np.random.rand(self.nclass, self.ndim) * 10
    ...
    def mapperKM(self,_, line):
        ...
        dis = ((corr - self.centroids) ** 2).sum(axis=1)
    ...
    def reducerKM(self, k_id, values):
        ...
        self.centroids = self.centroids[self.ndim*(int(k_id)+1):self.ndim*(int(k_id))]  / n_points
